...
subtitle: |
  ...
  10154.129472/2020-03    
author: "Luiz Fernando Palin Droubi"
date: "`r as.Date('2020-09-03')`"
...
#  
coords <- 
  matrix(c(742788.019, 6995501.248, #V1
           742670.007, 6995594.327, #V2
           743101.968, 6996143.370, #V3
           743219.980, 6996050.287, #V4
           742788.019, 6995501.248),#V1
         ncol = 2, byrow = TRUE)
#
# 2. Criação da feição  
#
...
attr <- data.frame(
  ...
  tipo = "aquatica",
  rip = NA,
  interessado = "BLV Aquacultura LTDA-ME",
  area = st_area(spl),
  area_uniao = st_area(spl),
  nup = "10154.129472/2020-03",
  protocolo = "Ofício 10360764 (7491205)",
  ref = 9238988,
  municipio = 8265,
  logradouro = NA,
  trecho = NA,
