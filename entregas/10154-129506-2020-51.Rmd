...
```{r}
nup <- "10154-129506-2020-51"
# 1. Digitação da Geometria
#  
coords <- 
  matrix(c(425923.119, 6960377.736, #V1
           425787.895, 6960001.509, #V2
           425630.023, 6960058.096, #V3
           425765.516, 6960434.634, #V4
           425923.119, 6960377.736),#V1
         ncol = 2, byrow = TRUE)
#
# 2. Criação da feição  
#
...
attr <- data.frame(
  ...
  tipo = "aquatica",
  rip = NA,
  interessado = "PISCICULTURA BMS LTDA- ME",
  area = st_area(spl),
  area_uniao = st_area(spl),
  nup = "10154.129506/2020-51",
  protocolo = "Ofício 8758341 (7493604)",
  ref = 8496000,
  municipio = NA,
  logradouro = NA,
  trecho = NA,
